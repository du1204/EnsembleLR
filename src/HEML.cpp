...
int main(int argc, char **argv) {
	...
	if(argc > 10) {
		...
		GD::shuffleZData(zDataTrain, factorDimTrain, sampleDimTrain);
		GD::normalizezData2(zDataTrain, zDataTest, factorDimTrain, sampleDimTrain, sampleDimTest); 
		if(isEncrypted) {
...
//			TestGD::testEncEnsembleNLGD2(fold, zDataTrain, zDataTest, factorDimTrain, sampleDimTrain, sampleDimTest, isYfirst, numIter, kdeg, gammaUp, gammaDown, isInitZero);
//			TestGD::testNewNLGD(fold, zDataTrain, zDataTest, factorDimTrain, sampleDimTrain, sampleDimTest, isYfirst, numIter, kdeg, gammaUp, gammaDown, isInitZero);
		} else {
			// TestGD::testPlainNLGD(zDataTrain, zDataTest, factorDimTrain, sampleDimTrain, sampleDimTest,
			// 		isYfirst, numIter, kdeg, gammaUp, gammaDown, isInitZero);
			TestGD::testPlainEnsembleNLGD2(fold, zDataTrain, zDataTest, factorDimTrain, sampleDimTrain, sampleDimTest, isYfirst, numIter, kdeg, gammaUp, gammaDown, isInitZero);
		}
	} else {
...
//			TestGD::testNewNLGD(fold, zData, factorDim, sampleDim, isYfirst, numIter, kdeg, gammaUp, gammaDown, isInitZero);
//			TestGD::testEncEnsembleNLGD(fold, zData, factorDim, sampleDim, isYfirst, numIter, kdeg, gammaUp, gammaDown, isInitZero);
		} else {
//			TestGD::testPlainNLGDFOLD(fold, zData, factorDim, sampleDim, isYfirst, numIter, kdeg, gammaUp, gammaDown, isInitZero);
			TestGD::testPlainEnsembleNLGD(fold, zData, factorDim, sampleDim, isYfirst, numIter, kdeg, gammaUp, gammaDown, isInitZero);
		}
	}
