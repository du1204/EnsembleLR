...
//static double degree5[4] = {-0.5,0.1167694,-0.0008352, 0.0000021}; // [-20, 20] 에서 비슷함, data set 클 때 사용하자!
...
//Hinge loss
// degree 0, degree 1, degree 2, degree 4 repectively
//static double degree4[4] = {-0.4783, 0.5, -0.1006, 0.00075};		// [-7, 7] 에서 비슷함 (0 근처에선 상당히 이상함)
static double degree4[4] = {-0.1776, 0.5, -0.2708, 0.0148};			// [-2, 2] 에서 비슷함
...
public:
	...
	static double* plainlinHinge(long approxDeg, double** zData, double* ip, long factorDim, long sampleDim, double gamma);
