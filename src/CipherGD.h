...
public:
	...
	void encZData_ensemble(Ciphertext* encZData, double** zData, long slots, long factorDim, long sampleDim, long batch, long cnum, long wBits, long logQ);
	...
	void encWVDataRandom(Ciphertext* encWData, Ciphertext* encVData, long cnum, long slots, long wBits, long logQ, double bound);
	...
	void enclinHinge(long kdeg, Ciphertext* encZData, Ciphertext* encGrad, Ciphertext& encIP, long cnum, double gamma, long sBits, long bBits, long wBits, long aBits);
	void encSigmoid_ensemble(long part, long kdeg, Ciphertext* encZData, Ciphertext* encGrad, Ciphertext& encIP, long cnum, double gamma, long sBits, long bBits, long wBits, long aBits);
	...
	void encNLGDiteration_ensemble(long part, long kdeg, Ciphertext* encZData, Ciphertext* encWData, Ciphertext* encVData, ZZX& poly, long cnum, double gamma, double eta, long sBits, long bBits, long wBits, long pBits, long aBits);

	void decWData(double* wData, Ciphertext* encWData, long factorDim, long batch, long cnum, long wBits);
//	void decWData_ensemble(long part, double* wData, Ciphertext* encWData, long factorDim, long batch, long cnum, long wBits);	
};
