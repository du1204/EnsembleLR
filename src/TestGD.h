...
public:
	...
	static void testPlainEnsembleNLGD(long fold, double** zData, long factorDim, long sampleDim,
			bool isYfirst, long numIter, long k, double gammaUp, double gammaDown, bool isInitZero);

	static void testEncEnsembleNLGD(long fold, double** zData, long factorDim, long sampleDim,
			bool isYfirst, long numIter, long k, double gammaUp, double gammaDown, bool isInitZero);


	static void testEncEnsembleNLGD2(long part, double** zData, double** zData_test, long factorDim, long sampleDim, long sampleDimTest,
			bool isYfirst, long numIter, long kdeg, double gammaUp, double gammaDown, bool isInitZero);
	static void testPlainEnsembleNLGD2(long part, double** zData, double** zData_test,long factorDim, long sampleDim, long sampleDimTest,
			bool isYfirst, long numIter, long kdeg, double gammaUp, double gammaDown, bool isInitZero);
	static void testNewNLGD(long part, double** zData, double** zData_test, long factorDim, long sampleDim, long sampleDimTest,
			bool isYfirst, long numIter, long k, double gammaUp, double gammaDown, bool isInitZero);
